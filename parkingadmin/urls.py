...
urlpatterns = [
    ...
    path('lectura_placa_vehiculo/<int:parqueadero_id>/', views.lectura_placa_vehiculo, name="lectura_placa_vehiculo"),
    path('ingreso_vehiculo/<int:parqueadero_id>/', views.ingreso_vehiculo, name="ingreso_vehiculo"),
    path('egreso_vehiculo/<int:parqueadero_id>/', views.egreso_vehiculo, name="egreso_vehiculo"),
